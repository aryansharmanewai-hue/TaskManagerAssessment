...
import TaskOverview from '../../Modals/EditCardModal/Features/TaskOverview';
...
const Board = (props) => {
	...
	const taskCount = useSelector((state) => state.board.taskCount);
	const completedTaskCount = useSelector((state) => state.board.completedTaskCount);
	const totalEffortEstimated = useSelector((state) => state.board.totalEffortEstimated);
	const totalEffortActual = useSelector((state) => state.board.totalEffortActual);
		...
		<>
			...
			>
				...
				<TaskOverview
					...
					totalEffortEstimated={totalEffortEstimated}
					totalEffortActual={totalEffortActual}
				/>
